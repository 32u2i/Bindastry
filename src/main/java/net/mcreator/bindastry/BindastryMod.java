 ...
 *
 */
package net.mcreator.bindastry;
...
@Mod("bindastry")
public class BindastryMod {
	public static final Logger LOGGER = LogManager.getLogger(BindastryMod.class);
	public static final String MODID = "bindastry";
	...
	public BindastryMod() {
		...
		BindastryModBiomes.REGISTRY.register(bus);
